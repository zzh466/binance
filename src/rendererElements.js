(function exposeRendererElements(root, factory) {
  ...
  const ELEMENT_SELECTORS = Object.freeze({
    ...
    depthLevelSwitchStatus: "#depthLevelSwitchStatus",
    ...
    zoomChartStatus: "#zoomChartStatus",
    zoomChartLatestTradePrice: "#zoomChartLatestTradePrice",
    zoomChartCanvas: "#zoomChartCanvas",
    zoomMousebar: "#zoomMousebar",
